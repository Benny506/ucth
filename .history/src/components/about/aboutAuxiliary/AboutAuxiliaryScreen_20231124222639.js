  ...
  return (
    <div>
      ...
      <div id='clinicalServiceDelivery' className='d-flex flex-wrap align-items-center justify-content-center justify-content-lg-between px-lg-5 px-4 py-5 mt-4'>
        <img src={clinical_image} className='img-fluid col-lg-5 col-md-8 col-10 mb-5 mb-md-0'/>
      ...
      <div className='d-flex flex-wrap align-items-center justify-content-center justify-content-lg-between px-5 py-4'>
        <div className='col-12 col-lg-6' id='welcomecontainer'>
