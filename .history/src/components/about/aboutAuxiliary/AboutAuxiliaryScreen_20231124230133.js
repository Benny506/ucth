...
function AboutAuxiliaryScreen() {
  return (
    <div>
      ...
      <div className='d-flex flex-wrap align-items-center justify-content-center justify-content-lg-between px-lg-5 px-4 py-5 mt-4'>
        <div className='col-12 col-lg-6 mb-4 mb-lg-0' id='welcomecontainer'>
          <h2 id='clinicalservicestext'>TRAINING & TEACHING</h2>
          <p className='py-3'>
          ...
          <a href='#traininglearnmore' className='btn py-2 px-4' id='traininglearnmorebutton'>Learn more</a>
        </div>
        <img src={training_image} className='img-fluid col-lg-5 col-md-8 col-10'/>
                                      ...
                                      {/* RESEARCH */}
      <div className='d-flex flex-column-reverse flex-lg-column flex-wrap align-items-center justify-content-center justify-content-lg-between px-lg-5 px-4 py-5 mt-4'>
