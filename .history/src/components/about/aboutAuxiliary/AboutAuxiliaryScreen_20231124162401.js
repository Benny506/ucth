...
function AboutAuxiliaryScreen() {
  return (
    <div>
      <div className='d-flex flex-wrap align-items-center px-lg-5 px-4 mt-4' id='welcomecontainer'>
        ...
        {/* <div className=' text-center'> */}
          <img src={old_lady} className='img-fluid col-lg-6 col-md-6 text-center col-12' />
        {/* </div> */}
      </div>
    </div>
