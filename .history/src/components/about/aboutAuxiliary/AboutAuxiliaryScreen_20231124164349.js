...
function AboutAuxiliaryScreen() {
  return (
    <div>
      <div className='d-flex flex-wrap align-items-center justify-content-between px-lg-5 px-4 mt-4' id='welcomecontainer'>
        ...
        {/* <div className=' text-center'> */}
          <img src={old_lady} className='img-fluid col-lg-5 col-md-18 col-10' />
        {/* </div> */}
      </div>
    </div>
