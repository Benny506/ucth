...
function AboutAuxiliaryScreen() {
  return (
    <div>
      <div className='d-flex flex-wrap align-items-center justify-content-between mx-lg-5 mx-4 mt-4' id='welcomecontainer'>
        ...
        {/* <div className=' text-center'> */}
          <img src={old_lady} className='img-fluid col-lg-5 col-md-6 text-center col-12' />
        {/* </div> */}
      </div>
    </div>
