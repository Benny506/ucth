    ...
    <div>
      ...
      <div className='d-flex flex-wrap align-items-center justify-content-center justify-content-lg-between px-lg-5 px-4 py-5 mt-4'>
        ...
        <img src={training_image} className='img-fluid col-lg-5 col-md-8 col-10'/>
                                      ...
                                      {/* RESEARCH */}
      <div className='d-flex flex-column-reverse flex-md-column flex-wrap align-items-center justify-content-center justify-content-lg-between px-lg-5 px-4 py-5 mt-4'>
