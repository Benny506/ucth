...
function AboutAuxiliaryScreen() {
  return (
    <div>
      ...
      <div id='clinicalServiceDelivery' className='d-flex flex-wrap align-items-center justify-content-center justify-content-lg-between px-lg-5 px-4 py-4'>
        <img src={clinical_image} className='img-fluid col-12 col-lg-5'/>
